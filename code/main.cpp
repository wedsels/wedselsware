...
int WINAPI wWinMain( ::HINSTANCE hInstance, ::HINSTANCE, ::PWSTR, int ) {
    ...
    ::input::globalkey[ VK_SNAPSHOT ] = []( bool down ) {
        if ( down ) {
            if ( ::input::state::ctrl ) {
    ...
    ::input::globalkey[ VK_INSERT ] = []( bool down ) {
        if ( down ) {
            if ( ::input::state::ctrl )
                ::queue::next( 1 );
            else
    ...
    ::input::globalkey[ VK_END ] = []( bool down ) {
        if ( down ) {
            if ( ::input::state::ctrl )
                ::queue::next( -1 );
            else
    ...
    ::input::globalkey[ VK_CAPITAL ] = []( bool down ) {
        if ( !down ) {
            if ( ::input::state::ctrl )
                ::execute( L"cmd.exe", 2 );
    ...
    ::input::globalkey[ VK_LMENU ] = []( bool down ) { ::input::state::alt = down; return false; };
    ::input::globalkey[ VK_RMENU ] = []( bool down ) { ::input::state::alt = down; return false; };
    ::input::globalkey[ VK_LSHIFT ] = []( bool down ) { ::input::state::shift = down; return false; };
    ::input::globalkey[ VK_RSHIFT ] = []( bool down ) { ::input::state::shift = down; return false; };
    ::input::globalkey[ VK_LCONTROL ] = []( bool down ) { ::input::state::ctrl = down; return false; };
    ::input::globalkey[ VK_RCONTROL ] = []( bool down ) { ::input::state::ctrl = down; return false; };
